        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <h4 class="d-inline">Cards With Footer and Links</h4>
                        <p class="text-muted">This is 3 column contents</p>
                        <div class="row">
                            <div class="col-md-6 col-lg-3">
                                <div class="card">
                ...
                <div class="row">
                    <div class="col-12 m-b-30">
                        <h4 class="d-inline">Cards With Header, Footer and Links</h4>
                        <p class="text-muted">This is 3 column contents</p>
                        <div class="row">
                            <div class="col-md-6 col-lg-3">
                                <div class="card">
                ...
                <div class="row">
                    <div class="col-12 m-b-30">
                        <h4 class="d-inline">Card with Navigation</h4>
                ...
                <div class="row">
                    <div class="col-12 m-b-30">
                        <h4 class="d-inline">Card Styles with Border color</h4>
                        <p>Add some navigation to a card’s header (or block) with Bootstrap’s nav components</p>
