            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Pagination Large</h4>
                                <div class="bootstrap-pagination">
                                    <nav>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Pagination Small</h4>
                                <div class="bootstrap-pagination">
                                    <nav>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Alignment Left</h4>
                                <div class="bootstrap-pagination">
                                    <nav>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Alignment Center</h4>
                                <div class="bootstrap-pagination">
                                    <nav>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Alignment Right</h4>
                                <div class="bootstrap-pagination">
                                    <nav>
