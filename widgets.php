                        ...
                        <li class="icons dropdown"><a href="javascript:void(0)" data-toggle="dropdown">
                            ...
                            <div class="drop-down animated fadeIn dropdown-menu dropdown-notfication">
                                ...
                                <div class="dropdown-content-body">
                                    ...
                                    <a class="d-flex justify-content-between gradient-4 px-4 text-white" href="javascript:void()">
                                    ...
                                    <div class="tdl-holder">
                                        <div class="tdl-content2 tdl-content--no-label">
                                            <ul>
                                                ...
                                                <li>
                                                    <label><input type="checkbox" checked><i></i><span>bed time</span><a href='#' class="ti-close"></a>
                                                    </label>
                                                    
                                                </li>
                                                <li>
                                                    <label><input type="checkbox" checked><i></i><span>Lorem ipsum time</span><a href='#' class="ti-close"></a>
                                                    </label>
...
$('#list-items').php(localStorage.getItem('listItems'));
...
localStorage.setItem('listItems', $('#list-items').php());
