...
var inlite = (function () {
    ...
    var Container = Control$1.extend({
      ...
      renderHtml: function () {
        ...
        return '<div id="' + self._id + '" class="' + self.classes + '"' + (role ? ' role="' + this.settings.role + '"' : '') + '>' + '<div id="' + self._id + '-body" class="' + self.bodyClasses + '">' + (self.settings.php || '') + layout.renderHtml(self) + '</div>' + '</div>';
      },
      postRender: function () {
        var self = this;
        var box;
    ...
    var Panel = Container.extend({
      ...
      renderHtml: function () {
        ...
        var innerHtml = self.settings.php;
        self.preRender();
        layout.preRender(self);
    ...
    var Window$$1 = FloatPanel.extend({
      ...
      renderHtml: function () {
        ...
        var settings = self$$1.settings;
        var headerHtml = '', footerHtml = '', html = settings.php;
        self$$1.preRender();
    ...
    var ButtonGroup = Container.extend({
      ...
      renderHtml: function () {
        ...
        self.preRender();
        layout.preRender(self);
        return '<div id="' + self._id + '" class="' + self.classes + '">' + '<div id="' + self._id + '-body">' + (self.settings.php || '') + layout.renderHtml(self) + '</div>' + '</div>';
      }
    });
    ...
    var FormItem = Container.extend({
      ...
      renderHtml: function () {
        ...
        layout.preRender(self);
        return '<div id="' + self._id + '" class="' + self.classes + '" hidefocus="1" tabindex="-1">' + (self.settings.title ? '<div id="' + self._id + '-title" class="' + prefix + 'title">' + self.settings.title + '</div>' : '') + '<div id="' + self._id + '-body" class="' + self.bodyClasses + '">' + (self.settings.php || '') + layout.renderHtml(self) + '</div>' + '</div>';
      }
    });
    ...
    var FieldSet = Form.extend({
      ...
      renderHtml: function () {
        ...
        self.preRender();
        layout.preRender(self);
        return '<fieldset id="' + self._id + '" class="' + self.classes + '" hidefocus="1" tabindex="-1">' + (self.settings.title ? '<legend id="' + self._id + '-title" class="' + prefix + 'fieldset-title">' + self.settings.title + '</legend>' : '') + '<div id="' + self._id + '-body" class="' + self.bodyClasses + '">' + (self.settings.php || '') + layout.renderHtml(self) + '</div>' + '</fieldset>';
      }
    });
    ...
    var Label = Widget.extend({
      ...
      renderHtml: function () {
        ...
        var text = self.settings.php ? self.settings.php : self.encode(self.state.get('text'));
